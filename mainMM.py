...
#LabelBase.register(name='simfang', fn_regular='simfang.ttf')
...
LabelBase.register(name="font", fn_regular="myinghwl.ttf")
...
class LanguagePage(Screen):
    ...
    def on_enter(self):
        ...
        b1_image_1 = Image(source='Dist.png')
        ...
        self.sub_b2_button_1 = Button(text='Bienvenue à\nDistSim', font_size=5, color=(0.6, 0, 0.6),
                                      size_hint=(None, None), size=(wh_size, wh_size),
                                      background_normal='LAN_French.png',
                                  background_color=tintshade_color, halign = 'center')
        self.sub_b2_button_2 = Button(text='欢迎', font_name="font", font_size=5, color=(0.0, 0.3, 0.5),
                                  size_hint=(None, None), size=(wh_size, wh_size),
...
class HomePage(Screen):
    def on_enter(self):
        ...
        button1 = Button(text=('Normal' if language_type == 'en' else
                         ...
                         size_hint=(0.95, None), size=(100, 160), font_name="font",
                         pos_hint={'center_x': 0.5},
                         font_size=80)
        ...
        button3 = Button(text=('Binomial' if language_type == 'en' else
                         ...
                         size_hint=(0.95, None), size=(100, 160), pos_hint={'center_x': 0.5},font_name="font",
                         font_size=80)
        ...
        button9 = Button(text=('Student\'s t' if language_type == 'en' else
                               ...
                               '学生 t 分布' if language_type == 'cn' else None),
                         size_hint=(0.95, None), size=(100, 160), pos_hint={'center_x': 0.5},font_name="font",
                         font_size=80)
        button9.background_color = (1, 0, 0.7, 1)

        welcome_text = Label(text='DistSim', size_hint=(None, None), size=(100, 180),font_name="font",
                             pos_hint={'center_x': 0.5},
        ...
        provide_text = Label(text=('Made possible by Banana Shaped Cow Studios' if language_type == 'en' else
                             ...
                             size_hint=(1, None), size=(100, 100),font_name="font",
                             pos_hint={'center_x': 0.5},
        ...
        welcome_description = Label(text=('The app offers visualizations of various important probability '
                                    ...
                                    size_hint=(0.9, None), size=(100, 350),font_name="font",
...
class FirstPage(Screen):
    def on_enter(self):
        ...
        if current_type == 1:
            ...
            first_input_name = ('Lower Bound (a)' if language_type == 'en' else
                    ...
                    '下界 (a)' if language_type == 'cn' else None)
        ...
        # Instructions label
        self.Apptitle = Label(text=f'{current_type_nameG}',font_name="font",
        ...
        self.description = Button(text=('Show Description' if language_type == 'en' else
                                  ...
                                  size_hint=(1, 0.1), pos_hint={'center_x': 0.5},font_name="font",
        ...
        self.N_input = Spinner(
            ...
            size_hint=(0.5, 0.1),font_name="font",
            height=50,
            font_size=50,
        ...
        if needed_inputs == 1:
            self.sub_box = BoxLayout(orientation='horizontal', spacing=10, size_hint=(1, 0.2))
            self.sub_box_1 = BoxLayout(orientation='vertical', spacing=10, size_hint=(1, 1))

            self.first_input_1 = Label(text=f'{first_input_name}',
                                       size_hint=(0.5, 1), font_size=50, color=(1, 0, 1),font_name="font",
                                       pos_hint={'center_x': 0.5, 'center_y': 1})

            self.first_input_2 = TextInput(hint_text=first_input_name, size_hint=(1, 1),font_name="font",
            ...
            self.first_input_1 = Label(text=f'{first_input_name}',font_name="font",
                                       size_hint=(0.5, 1), font_size=43, color=(1, 0, 1),
                                       pos_hint={'center_x': 0.5, 'center_y': 1})
            ...
            self.second_input_1 = Label(text=f'{second_input_name}',font_name="font",
                                        size_hint=(0.5, 1), font_size=43, color=(1, 0, 1),
                                        pos_hint={'center_x': 0.5, 'center_y': 1})
            self.second_input_2 = TextInput(hint_text=second_input_name, size_hint=(1, 1),font_name="font",
                                            font_size=50, halign="center", pos_hint={'center_x': 0.5, 'center_y': .8},
                                            foreground_color=(0, 0, 1))
        ...
        empty_text = Label(text=' ', size_hint=(1, .01), size=(100, 200),
                           pos_hint={'center_x': 0.5},font_name="font",
        ...
        logo = BoxLayout(orientation='vertical', spacing=10, size_hint=(1, .3),
                         pos_hint={'center_x': 0.5, 'center_y': 0.5})
        empty_text = Label(text=' ', size_hint=(1, .02),
                           pos_hint={'center_x': 0.5},
                           font_size=30, color=(0.2, 0.8, 0.2))
        empty_text.bind(
            height=lambda *x: empty_text.setter('text_size')(empty_text, (empty_text.height, None)))
        ...
        button_box_1 = Button(text=('Central Limit Theorem\n(CLT) Demo' if language_type == 'en' else
                              ...
                              size_hint=(0.5, 1),font_name="font",
        ...
        button_box_2 = Button(text=('Explanation\nAudio 1' if language_type == 'en' else
                              ...
                              font_size=40, halign='center', size_hint=(0.25, 1),font_name="font",
    ...
    def show_popup(self, instance):
        ...
        message_label = Label(text='', size_hint=(1, None), pos_hint={'center_y': 0.6},
                              font_name="font", halign='center', font_size=50)
        ...
        if current_type == 1:
            message_label.text = ('A normal (or Gaussian; named after Carl Friedrich Gauss) distribution is a '
                                  ...
                                  '正态（或高斯分布；以 Carl Friedrich Gauss 命名）分布是实值随机变量的连续概率分布。正态分布有两个参数，'
            ...
            message_label.text = ('The binomial distribution is the discrete probability distribution of the number '
                                  ...
                                  '二项分布是 n 个独立实验序列中成功次数的离散概率分布。对于单个实验，即 n = 1，二项分布是伯努利（'
                                  'Jacob Bernoulli）分布。二项分布有两个参数，包括 n（实验次数）和 p（成功率）。'
                                  if language_type == 'cn' else None)
        elif current_type == 4:
            message_label.text = ('The beta distribution is a family of continuous probability distributions defined '
                                  ...
                                  '贝塔分布是定义在 0 和 1 区间上的一族连续概率分布。贝塔分布有两个参数，分别用 alpha (α) 和 beta '
                                  '(β) 表示，它们控制分布的形状。它被广泛用作贝叶斯数据分析中的先验分布。'
                                  if language_type == 'cn' else None)
        elif current_type == 5:
            ...
            message_label.text = ('The Chi-squared distribution with k degrees of freedom is the distribution of a '
                                  ...
                                  if language_type == 'fr' else
                                  '自由度为 k 的卡方分布是 k 个独立标准正态随机变量的平方和的分布。卡方分布是伽玛分布的特例，是推论统计中'
                                  '使用最广泛的概率分布之一。'
                                  if language_type == 'cn' else None)
        elif current_type == 8:
            message_label.text = ('The exponential distribution is the probability distribution of the time between '
                                  ...
                                  '被描述为无记忆的，因为在特定时间间隔内发生事件的概率不依赖于经过的时间。'
                                  if language_type == 'cn' else None)
        elif current_type == 9:
            message_label.text = ('Student (named after William Sealy Gosset) t-distribution is a continuous '
                                  ...
                                  if language_type == 'fr' else
                                  '学生（以 William Sealy Gosset 的名字命名）t 分布是一种推广标准正态分布的连续概率分布。对于等于 '
                                  '1 的自由度，学生 t 分布成为标准柯西分布，而对于接近无穷大的自由度，t 分布收敛于标准正态分布。我们经常的使用'
                                  '双样本 t 检验就是基于 t 分布。t 检验允许被比较的两组之间存在不相等的方差。'
                                  if language_type == 'cn' else None)
    ...
    def create_plot(self, instance):
        ...
        axs[1].axhline(mean_value, color='r', linestyle='--', label=('Mean' if language_type == 'en' else
                                                                     ...
                                                                     '平均值' if language_type == 'cn' else None))
        ...
        # Calculate the desired height proportion for the histogram
        #histogram_height = 1.7  # Adjust this value as needed

        # Set the height of the histogram widget within the layout
        #canvas.size_hint_y = histogram_height
...
class SecondPage(Screen):
    ...
    def on_enter(self):
        ...
        self.CLT_title = Label(text=(f'{current_type_name} CLT' if language_type == 'en' else
                               ...
                               size_hint=(1, 0.1), font_name='font', font_size=50, color=(0, 1, 0),
                               pos_hint={'center_x': 0.5, 'center_y': 1})

        # possible description label
        self.CLT_description = Button(text=('Visualization Described' if language_type == 'en' else
                                            'Visualisierung beschrieben' if language_type == 'de' else
                                            'Visualisation décrite' if language_type == 'fr' else
                                            '可视化描述' if language_type == 'cn' else None),font_name="font",
        ...
        self.iterations_slider = Slider(min=2, max=30, value=10, value_track=True, value_track_color=[0.5, 0.7, 0.8, 1],
                                        height=50, size_hint=(0.95, None), pos_hint={'center_x':
                                                                                                           0.5, 'center_y': 0.5})
        self.iterations_text = Label(
            text=('Slide to input the number of i.i.d. distributions.' if language_type == 'en' else
                  ...
                  '滑动输入 i.i.d 分布的数量。' if language_type == 'cn' else None), height=100,
            size_hint=(0.9, None), font_size=39, halign='center', valign='bottom', font_name="font",
            pos_hint={'center_x': 0.5, 'center_y': 0.5})
        ...
        self.simulations_text = Label(text=('Number of Simulations' if language_type == 'en' else
                                            ...
                                            'Nombre de simulations' if language_type == 'fr' else
                                            '模拟次数' if language_type == 'cn' else None),
                                      size_hint=(1, 0.1), font_name="font",
                                      font_size=50,
                                      halign='center',
                                      valign='center',
                                      text_size=(self.width, None),
        ...
        empty_text = Label(text=' ', size_hint=(1, .12), size=(100, 200),font_name='font',
                           pos_hint={'center_x': 0.5},
                           font_size=30, color=(0.2, 0.8, 0.2))
        empty_text.bind(
            height=lambda *x: empty_text.setter('text_size')(empty_text, (empty_text.height, None)))
    ...
    def CLT_popup(self, instance):
        ...
        # Create a label with the message
        message_label = Label(text='', size_hint=(1, None), pos_hint={'center_y': 0.6}, halign='center',font_name="font",
                              font_size=50)
        ...
        message_label.text = ('First set the number (N) of independent identical distributed  (i.i.d.) samples to be '
                              ...
                              'également générées.'
                              if language_type == 'fr' else
                              f'首先使用下面的滑块设置要创建的独立同分布 (i.i.d.) 样本的数量 (N)。然后，设置每个分布的模拟值的数量 (S)。'
                              f'该程序将计算每次模拟的 N 个分布的平均值，并用 S 次的模拟生成直方图。出于比较目的，还用其中一个 i.i.d. '
                              f'的模拟值生成直方图。'
                              if language_type == 'cn' else None)
    ...
    def create_plot(self, instance, idk):
        ...
        self.axs[1].set_title((f'Histogram of one {current_type_nameG}'
                               ...
                               if language_type == 'cn' else None), fontsize=16 )
